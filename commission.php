...
$headers .= "From: test@gmail.com" . "\r\n";
    ...
    $queryAuthor="SELECT userID,username FROM korisnik WHERE userID='". $_GET['id']."'";
    ...
    $mail="Hey " . ucwords(strtolower($rowAuthor['username']))." it seems that " . ucwords($_SESSION['login_user']). " wants to commission you!\n";
    $mail.="This is his/hers mail: ". $row['mail'] ."\n";
    $mail.="Please contact him/her to arrange the details!";  
    print($mail); 
    print("Click here to get back: <a href=\"user.php?id=".$_GET['id']."\">Link.</a>");
